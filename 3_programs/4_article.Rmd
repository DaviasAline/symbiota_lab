...
# Figure S1
Heatmap of correlation between the sIgA level at 3 months, the gut microbiota at 3 and 12 months and the Bayley cognitive scale at 12 and 24 months of age in the children from the Canadian CHILD study cohort
```{r echo=FALSE, fig.height=12, fig.width=11, message=FALSE, warning=FALSE}
figure_S1 <- bdd_filtered %>% 
...
# Figure S2
Direct Acyclic Graph of the relation between sIgA levels at 3 months, gut microbiota at 3 months, and Bayley cognitive scores in infancy.
