...
bdd_figure_1_long <- bdd_figure_1_long %>%
  rename("Proteobacteria" = p__Proteobacteria_3M,
         ...
         "Clostrioides difficile" = Cdiff_num_3M_ln, 
...
figure_1_b <- bdd_figure_1_long %>%
 filter(name %in% c("Streptococcus", "Lactobacillus", "Enterococcus", "Clostrioides difficile")) %>%
 ggplot() +
  aes(x = value, y = name, fill = sIgA_3m_cat_CutOff5) +
  geom_boxplot() +
  scale_fill_hue(direction = 1) +
...
bdd_figure_S4_long <- bdd_figure_S4_long %>%
  rename("Proteobacteria" = p__Proteobacteria_Y1,
         ...
         "Clostrioides difficile" = Cdiff_num_Y1_ln) %>%
  pivot_longer(cols = c(-sIgA_3m_cat_CutOff5, -ident))%>%
  mutate(
    name = fct_relevel(name,
    "Clostrioides difficile", "Enterococcus", "Lactobacillus", "Streptococcus",
