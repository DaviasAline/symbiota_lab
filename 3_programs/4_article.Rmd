...
figure_S3 <- bdd_filtered %>% 
  ...
  rename(`Lachnospiraceae Y1` = f__Lachnospiraceae_g___Y1, 
         `Enterobacteriaceae M3` = f__Enterobacteriaceae_g__3M, ) %>%
  rename_with(~ gsub("p__", "", .x)) %>%
  rename_with(~ gsub("g__", "", .x)) %>%
  rename_with(~ gsub("_Y1", " Y1", .x)) %>%
  rename_with(~ gsub("_3M", " M3", .x)) %>%
  rename_with(~ gsub("metabolite_", "", .x)) %>%
  rename_with(~ gsub("Cdiff_num", "Clostridium difficile", .x)) %>%
  rename(`Acetate metabolite M3` = Acetate, 
         `Propionate metabolite M3` = Propionate, 
         `Butyrate metabolite M3` = Butyrate, 
         `Tryptophan metabolite M3` = Tryptophan, 
         `Taurine metabolite M3` = Taurine, 
         `Lactate metabolite M3` = Lactate, 
         `Formate metabolite M3` = Formate, 
         `Tyrosine metabolite M3` = Tyrosine, 
         `Valerate metabolite M3` = Valerate) %>%
  select(
  ...
  'Firmicutes Y1',
  'Proteobacteria Y1',
  'Valerate metabolite M3',
  'Tyrosine metabolite M3',
  'Formate metabolite M3',
  'Lactate metabolite M3',
  'Taurine metabolite M3',
  'Tryptophan metabolite M3',
  'Butyrate metabolite M3',
  'Propionate metabolite M3',
  'Acetate metabolite M3',
...
figure_S3 <- cor(figure_S3, method = "spearman", use = "pairwise.complete.obs")
...
ggsave(plot = figure_S1, 
       filename = "C:/Users/Aline/OneDrive - etu.univ-grenoble-alpes.fr/Documents/10. Symbiota lab project/figures/article/figure_S1.tiff", 
       units = "mm", 
       height = 250, 
       width = 250)
```
...
# write.xlsx(list(table_2b = table_2b,
#                 table_3_boots = table_3_boots,
#                 table_3_boots_bis = table_3_boots_bis,
#                 table_4_boots = table_4_boots,
#                 additional_table_1_boots = additional_table_1_boots,
#                 additional_table_1_boots_bis = additional_table_1_boots_bis,
#                 additional_table_2_boots = additional_table_2_boots),
#            "C:/Users/Aline/OneDrive - etu.univ-grenoble-alpes.fr/Documents/10. Symbiota lab project/test_corrected_2023_09_26 (with bootsraping).xlsx")
# 
# write.xlsx(list(table_2b = table_2b,
#                 table_3_boots = table_3_boots,
#                 table_3_boots_bis = table_3_boots_bis,
...
#                 additional_table_1_boots_bis = additional_table_1_boots_bis,
#                 additional_table_2_boots = additional_table_2_boots),
#            "C:/Users/Aline/OneDrive - etu.univ-grenoble-alpes.fr/Documents/10. Symbiota lab project/test_corrected_2023_10_01 (with bootsraping).xlsx")
```
